...
train_ann_file = 'annotations/instances_train_fold_8.json'
val_ann_file = 'annotations/instances_val_fold_8.json'
...
#     outfile_prefix='test2-0627_fold8',  # 要保存的 JSON 文件的前缀
# )
