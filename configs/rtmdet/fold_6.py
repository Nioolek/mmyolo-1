...
train_ann_file = 'annotations/instances_train_fold_6.json'
val_ann_file = 'annotations/instances_val_fold_6.json'
...
#     outfile_prefix='test2-0627_fold6',  # 要保存的 JSON 文件的前缀
# )
